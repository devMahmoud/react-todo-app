...
# react-todo-app
"React Todo App" is a simple React application for managing todos. It is a Single Page App (SPA) that allows users to:
...
To have a local version of this project run this comman in your teminal.
    git clone https://github.com/devMahmoud/react-todo-app.git
